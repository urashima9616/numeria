...
# ---- P3 天空城与多样规律 ----
bake "What tile comes next in the pattern?"
bake "Which tile fills the pattern gap?"
bake "Find the exact tile pattern!"
bake "Find the tiles in mirror order!"
bake "Match the shapes. Colors can change!"
bake "Match the colors. Shapes can change!"
bake "Balance both sides. What number is missing?"
bake "Which number fills the path?"
