    ...
    public static partial class Maps
    {
        ...
        public static MapDef Forest() => new MapDef
        {
            ...
            Rows = new[]
            {
                ...
                Row("T...TTTT", "TT....~~", "~...TTTT", "TT.....T"),
                Row("T.S=====", "==..bb~~", "~....C..", "..TT...T"),
                Row("T..bbb..", ".==...~~", "~..TT...", "...TT..T"),
                Row("T..bbb..", "..=TTT~~", "~..TT...", "C......T"),
                Row("T..TT...", "..====BB", "B====...", "...TT..T"),
                Row("T..T....", "bb....~~", "~..=bb..", "...TT..T"),
                Row("T..T..L.", "bb....~~", "~..===..", ".......T"),
                Row("T..T....", "......~~", "~..T.=..", "..C....T"),
                Row("T.C...TT", "T..bbb~~", "~..T.===", "==.....T"),
                Row("T....TT.", "...bbb~~", "~..TT.bb", ".=.....T"),
                Row("T..bb...", "...bbb~~", "~.....bb", ".===...T"),
                Row("T..bb...", "..====BB", "B=======", "====...T"),
                Row("T....TT.", "....bb~~", "~...TT..", "...==..T"),
                Row("T.C..TT.", "....bb~~", "~...TT..", "...=...T"),
            ...
            Discoveries = new[]
            {
                D("forest-rune-1", "Firefly Number Rune", 5, 3, 4),
                D("forest-rune-2", "Mushroom Pattern Rune", 11, 6, 5, ConsumableType.HealthPotion, 1),
                D("forest-rune-3", "Leaf Symmetry Rune", 23, 10, 5),
                D("forest-rune-4", "Acorn Counting Rune", 10, 15, 6, ConsumableType.GemSnack, 1),
            },
            Merchant = new MerchantDef
            {
                Id = "forest-tessa", Name = "Tessa", X = 26, Y = 14,
        ...
        public static MapDef Mountains() => new MapDef
        {
            ...
            ChestRewards = new Dictionary<string, ChestRewardDef>
            {
                { "mountains-chest-30-1", R(ChestRewardType.EvolutionStone, "Evolution Stone") },
                { "mountains-chest-14-3", R(ChestRewardType.HealthPotion, "Peak Potion", 2) },
                { "mountains-chest-1-6", R(ChestRewardType.DefenseCharm, "Granite Guard") },
                { "mountains-chest-27-8", R(ChestRewardType.GemSnack, "Gem Biscuit", 3) },
                { "mountains-chest-3-10", R(ChestRewardType.HealthPotion, "Warm Cocoa", 3) },
            },
            Discoveries = new[]
            {
                D("mountains-rune-1", "Echo Addition Rune", 5, 2, 7),
                D("mountains-rune-2", "Twin Stone Rune", 12, 6, 8, ConsumableType.HealthPotion, 1),
                D("mountains-rune-3", "Peak Order Rune", 25, 9, 9),
                D("mountains-rune-4", "Crystal Difference Rune", 7, 16, 10, ConsumableType.GemSnack, 1),
            },
            Merchant = new MerchantDef
            {
                Id = "mountains-bram", Name = "Bram", X = 25, Y = 16,
        ...
        public static MapDef Sky() => new MapDef
        {
            ...
            Encounters = new[]
            {
                ...
                E("seedseq", 8, 15, -1, 2), E("numblet", 10, 15, -1, 2),
                E("tallywing", 5, 18, 0, 3),
            },
            ...
            ChestRewards = new Dictionary<string, ChestRewardDef>
            {
                { "sky-chest-21-2", R(ChestRewardType.EvolutionStone, "Evolution Stone") },
                { "sky-chest-10-5", R(ChestRewardType.GemSnack, "Cloud Candy", 3) },
                { "sky-chest-28-6", R(ChestRewardType.DefenseCharm, "Mirror Feather") },
                { "sky-chest-28-10", R(ChestRewardType.HealthPotion, "Sky Elixir", 3) },
                { "sky-chest-2-13", R(ChestRewardType.GemSnack, "Starlight Candy", 2) },
            },
            Discoveries = new[]
            {
                D("sky-rune-1", "Cloud Sequence Rune", 6, 3, 10),
                D("sky-rune-2", "Prism Balance Rune", 13, 6, 11, ConsumableType.GemSnack, 1),
                D("sky-rune-3", "Mirror Wing Rune", 25, 11, 12),
                D("sky-rune-4", "Starlight Pattern Rune", 12, 15, 14, ConsumableType.HealthPotion, 1),
            },
            Merchant = new MerchantDef
            {
                Id = "sky-ari", Name = "Ari", X = 25, Y = 16,
        ...
        public static MapDef Desert() => new MapDef
        {
            ...
            Encounters = new[]
            {
                ...
                E("patternpod", 8, 24, -2, 2), E("tallywing", 4, 26, -1, 3),
                E("totalon", 2, 30, 0, 3),
            },
            ...
            ChestRewards = new Dictionary<string, ChestRewardDef>
            {
                ...
                { "desert-chest-7-5", R(ChestRewardType.HealthPotion, "Cactus Tonic", 4) },
                { "desert-chest-3-8", R(ChestRewardType.AttackCharm, "Solar Fang") },
                { "desert-chest-25-11", R(ChestRewardType.GemSnack, "Dune Candy", 4) },
                { "desert-chest-2-13", R(ChestRewardType.DefenseCharm, "Mirage Mantle") },
            },
            Discoveries = new[]
            {
                D("desert-rune-1", "Dune Addition Rune", 5, 2, 15),
                D("desert-rune-2", "Sun Balance Rune", 14, 6, 16, ConsumableType.HealthPotion, 1),
                D("desert-rune-3", "Cactus Sequence Rune", 26, 11, 18),
                D("desert-rune-4", "Mirage Symmetry Rune", 7, 16, 20, ConsumableType.GemSnack, 1),
            },
            Merchant = new MerchantDef
            {
                Id = "desert-nia", Name = "Nia", X = 26, Y = 16,
