...
{
    public enum Tile { Grass, Tree, Bush, Chest, Portal }

    /// <summary>
    /// ASCII 网格地图:'.'=草地 'T'=树(不可走) 'b'=草丛(遇敌) 'C'=宝箱 'P'=传送门 'S'=出生点。
    ...
    public class GridMap
    {
        ...
        public bool Walkable(int x, int y) => InBounds(x, y) && _tiles[x, y] != Tile.Tree;
