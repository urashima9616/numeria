...
namespace Numeria.Core
{
    ...
    public static class GameData
    {
        private static readonly EvolutionLineDef[] EvolutionLines =
        {
            ...
            Line("mirrowl", "SKY", "mirrors and pattern matching", PuzzleAffinity.Symmetry,
            ...
            Line("prismouse", "SKY", "shapes and balance", PuzzleAffinity.Symmetry,
            ...
            Line("loopling", "DRAGON", "spirals and sequences", PuzzleAffinity.Symmetry,
